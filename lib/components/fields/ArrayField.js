...
var ArrayField = function (_Component) {
  ...
  function ArrayField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ArrayField.__proto__ || Object.getPrototypeOf(ArrayField)).call.apply(_ref, [this].concat(args))), _this), _this.onAddClick = function (event, localFormData) {
      console.log("hello", localFormData);
      ...
      if (localFormData) _this.props.onChange(localFormData);else _this.props.onChange([].concat(_toConsumableArray(formData), [(0, _utils.getDefaultFormState)(itemSchema, undefined, definitions)]));
